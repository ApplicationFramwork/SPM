        ...
        return (
            <div className="row">
                <div className="col-sm-12 nav_body bg-light">
                    ...
                    <div className="row">
                        <a href="MarkAttendance"><p className="NavItem"><i className="fas fa-marker m-2"></i> Attendance</p> </a>
                    </div>
                    ...
                    <div className="row">
                        <a href={"/AddMarks"}><p className="NavItem"><i className="fas fa-chart-line m-2"></i>Marks</p> </a>
                    </div>
